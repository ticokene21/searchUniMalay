...
<div >
    <div id="container">
        <div class="row" id="subject">
            ...
            <label class="col-md-2" for="" id="your-grades">Level</label>
            <label class="col-md-2" for="" id="your-grades">Group</label>
        </div>
        <div class="row">
            <div class="col-md-6" >
                <div ng-repeat="arr in arrInput track by $index" >
                    <div id ="requirement">
                        ...
                        <div class="col-md-6" ng-if="arr.listreq.input_type == 1" >
                        ...
                        <!--                        </div>-->
                        <!--                    </div>-->
                        <div class="col-md-6" ng-if="arr.listreq.input_type == 2 " >
                            <div class="subject-select" ng-repeat="sub in arr.listreq.listsub">
                                <select class="entry-subject-select" ng-options="sub as sub.sub_name for sub in arr.subOfReq track by sub.sub_id" ng-model="sub" ng-change="ChangeSelectSub($parent.$index,$index,sub)"></select>
            ...
            <div class="col-md-6">
                <select ng-options=" level.level_name for level in itemlevel " ng-model="level" ng-init="level = itemlevel[0]"></select>
                <select ng-options=" group.group_name for group in itemgroup " ng-model="group" ng-init="group = itemgroup[0]"></select>
            </div>
        </div>
